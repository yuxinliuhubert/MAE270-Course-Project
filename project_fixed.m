...
% Task 0 - Data Preparation begins.
disp('Task 0: Data Preparation begins.');
...
disp('Task 0: Data Preparation completed.');
disp('----------------------------------------');
...
% The energies should be approximately equal according to Parseval's theorem.
...
for idx = 1:num_models
    ...
    B = B_models{idx};
    C = C_models{idx};
    D = D_models{idx}; % Retrieve D here
